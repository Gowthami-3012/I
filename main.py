# pip install flask opencv-contrib-python numpy pillow tensorflow
...
CATEGORIES = {0: {'Apple': "Apple Plant Leaf"},
    1: {'Blueberry': "Blueberry Plant Leaf"},
    2: {'Cherry': "Cherry Plant Leaf"},
    5: {'Peach': "Peach Plant Leaf"},
    6: {'Bell Pepper': "Bell Pepper Leaf"},
    7: {'Potato': "Potato Leaf"},
    8: {'Raspberry': "Raspberry Plant Leaf"},
    9: {'Soybean': "Soybean Plant Leaf"},
    10: {"Strawberry":"Strawberry Plant Leaf"},
    11: {"Tomato": "Tomato Plant Leaf"}
    }
...
def first_page():
    if request.method=="POST":
        ...
        if file and allowed_file(file.filename):
            ...
            result = list(op.keys())[0]
            solution = op[result]
            return render_template("data_page.html",
                           filename=filename, result = result, solution = solution.split("\n"))
        else:
